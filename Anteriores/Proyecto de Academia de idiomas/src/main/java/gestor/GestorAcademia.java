...
public class GestorAcademia {
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 3 -> menuCursos();
            case 4 -> menuMatriculasNotas();
            case 5 -> menuNivelesIdioma();
            case 6 -> mostrarMenuReportesHTML();
    ...
    do {
        ...
        switch (opcion) {
            case 1 -> registrarNivelIdioma();
            case 2 -> buscarNivelIdioma();
            case 3 -> modificarNivelIdioma();
            case 4 -> eliminarNivelIdioma();
            case 0 -> System.out.println("Volviendo al menu principal...");
            default -> System.out.println("Opcion invalida.");
        }
    } while (opcion != 0);
    ...
    do {
        ...
        switch (opcion) {
            case 1 -> generarReporteEstudiantesHTML();
            case 2 -> generarReporteProfesoresHTML();
            case 3 -> generarReporteCursosHTML();
            case 4 -> generarReporteMatriculasHTML();
            case 5 -> generarReporteCalificacionesHTML();
            case 6 -> generarReporteNivelesIdiomaHTML();
            case 0 -> System.out.println("Volviendo al menu principal...");
